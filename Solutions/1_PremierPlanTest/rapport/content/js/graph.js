...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 1.0, "minX": 0.0, "maxY": 105.0, "series": [{"data": [[0.0, 104.0], [200.0, 1.0]], "isOverall": false, "label": "PRODUITS", "isController": false}, {"data": [[0.0, 105.0]], "isOverall": false, "label": "HOME", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 200.0, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.58565612E12, "maxY": 1.0, "series": [{"data": [[1.58565678E12, 1.0], [1.58565636E12, 1.0], [1.5856569E12, 1.0], [1.58565684E12, 1.0], [1.58565612E12, 1.0]], "isOverall": false, "label": "Application Web", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5856569E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 5.076190476190477, "minX": 1.0, "maxY": 10.371428571428568, "series": [{"data": [[1.0, 10.371428571428568]], "isOverall": false, "label": "PRODUITS", "isController": false}, {"data": [[1.0, 10.371428571428568]], "isOverall": false, "label": "PRODUITS-Aggregated", "isController": false}, {"data": [[1.0, 5.076190476190477]], "isOverall": false, "label": "HOME", "isController": false}, {"data": [[1.0, 5.076190476190477]], "isOverall": false, "label": "HOME-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 1.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 20.5, "minX": 1.58565612E12, "maxY": 2688.3333333333335, "series": [{"data": [[1.58565678E12, 2688.3333333333335], [1.58565636E12, 2688.3333333333335], [1.5856569E12, 2688.3333333333335], [1.58565684E12, 2688.3333333333335], [1.58565612E12, 537.6666666666666]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.58565678E12, 102.5], [1.58565636E12, 102.5], [1.5856569E12, 102.5], [1.58565684E12, 102.5], [1.58565612E12, 20.5]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5856569E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.9999999999999987, "minX": 1.58565612E12, "maxY": 65.8, "series": [{"data": [[1.58565678E12, 7.119999999999999], [1.58565636E12, 7.640000000000001], [1.5856569E12, 9.280000000000001], [1.58565684E12, 6.360000000000001], [1.58565612E12, 65.8]], "isOverall": false, "label": "PRODUITS", "isController": false}, {"data": [[1.58565678E12, 4.32], [1.58565636E12, 4.3999999999999995], [1.5856569E12, 6.8], [1.58565684E12, 3.9999999999999987], [1.58565612E12, 9.0]], "isOverall": false, "label": "HOME", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5856569E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 3.7199999999999993, "minX": 1.58565612E12, "maxY": 65.6, "series": [{"data": [[1.58565678E12, 6.800000000000001], [1.58565636E12, 7.3999999999999995], [1.5856569E12, 9.000000000000002], [1.58565684E12, 6.239999999999999], [1.58565612E12, 65.6]], "isOverall": false, "label": "PRODUITS", "isController": false}, {"data": [[1.58565678E12, 4.0], [1.58565636E12, 4.239999999999999], [1.5856569E12, 6.36], [1.58565684E12, 3.7199999999999993], [1.58565612E12, 8.8]], "isOverall": false, "label": "HOME", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5856569E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.58565612E12, "maxY": 4.0, "series": [{"data": [[1.58565678E12, 0.0], [1.58565636E12, 0.0], [1.5856569E12, 0.0], [1.58565684E12, 0.0], [1.58565612E12, 0.0]], "isOverall": false, "label": "PRODUITS", "isController": false}, {"data": [[1.58565678E12, 0.8800000000000001], [1.58565636E12, 1.0], [1.5856569E12, 1.08], [1.58565684E12, 0.9999999999999999], [1.58565612E12, 4.0]], "isOverall": false, "label": "HOME", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5856569E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.58565612E12, "maxY": 299.0, "series": [{"data": [[1.58565678E12, 30.0], [1.58565636E12, 32.0], [1.5856569E12, 38.0], [1.58565684E12, 31.0], [1.58565612E12, 299.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.58565678E12, 2.0], [1.58565636E12, 1.0], [1.5856569E12, 2.0], [1.58565684E12, 2.0], [1.58565612E12, 2.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.58565678E12, 8.0], [1.58565636E12, 9.899999999999999], [1.5856569E12, 12.899999999999999], [1.58565684E12, 8.899999999999999], [1.58565612E12, 272.30000000000007]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.58565678E12, 30.0], [1.58565636E12, 32.0], [1.5856569E12, 38.0], [1.58565684E12, 31.0], [1.58565612E12, 299.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.58565678E12, 13.599999999999966], [1.58565636E12, 19.799999999999983], [1.5856569E12, 21.799999999999983], [1.58565684E12, 12.349999999999987], [1.58565612E12, 299.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5856569E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 4.0, "minX": 4.0, "maxY": 19.5, "series": [{"data": [[4.0, 19.5], [20.0, 5.5], [10.0, 4.5], [40.0, 4.0], [6.0, 5.0], [50.0, 6.0], [30.0, 5.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 50.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 4.0, "minX": 4.0, "maxY": 19.0, "series": [{"data": [[4.0, 19.0], [20.0, 5.0], [10.0, 4.5], [40.0, 4.0], [6.0, 5.0], [50.0, 6.0], [30.0, 5.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 50.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.16666666666666666, "minX": 1.58565612E12, "maxY": 0.8333333333333334, "series": [{"data": [[1.58565678E12, 0.8333333333333334], [1.58565636E12, 0.8333333333333334], [1.5856569E12, 0.8333333333333334], [1.58565684E12, 0.8333333333333334], [1.58565612E12, 0.16666666666666666]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5856569E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 0.16666666666666666, "minX": 1.58565612E12, "maxY": 0.8333333333333334, "series": [{"data": [[1.58565678E12, 0.8333333333333334], [1.58565636E12, 0.8333333333333334], [1.5856569E12, 0.8333333333333334], [1.58565684E12, 0.8333333333333334], [1.58565612E12, 0.16666666666666666]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5856569E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.08333333333333333, "minX": 1.58565612E12, "maxY": 0.4166666666666667, "series": [{"data": [[1.58565678E12, 0.4166666666666667], [1.58565636E12, 0.4166666666666667], [1.5856569E12, 0.4166666666666667], [1.58565684E12, 0.4166666666666667], [1.58565612E12, 0.08333333333333333]], "isOverall": false, "label": "PRODUITS-success", "isController": false}, {"data": [[1.58565678E12, 0.4166666666666667], [1.58565636E12, 0.4166666666666667], [1.5856569E12, 0.4166666666666667], [1.58565684E12, 0.4166666666666667], [1.58565612E12, 0.08333333333333333]], "isOverall": false, "label": "HOME-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5856569E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 0.16666666666666666, "minX": 1.58565612E12, "maxY": 0.8333333333333334, "series": [{"data": [[1.58565678E12, 0.8333333333333334], [1.58565636E12, 0.8333333333333334], [1.5856569E12, 0.8333333333333334], [1.58565684E12, 0.8333333333333334], [1.58565612E12, 0.16666666666666666]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5856569E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
